...
var (
	tbPurple      = lipgloss.Color("#682A8D") // primary brand purple
	tbLightPurple = lipgloss.Color("#A07EBA") // light purple
	tbOffWhite    = lipgloss.Color("#E8E0ED") // slight purple tint on white
